...
import { useScroll, useAnimationControls, useMotionValueEvent, useReducedMotion } from "framer-motion";
  ...
  useMotionValueEvent(scrollYProgress, "change", (latest) => {
    ...
    if (isScrollingDown && latest > 0.02 && !hasEnteredRef.current) {
      ...
      imageControls.start({
        x: [280, -24, 14, -6, 0], 
        opacity: [0, 1, 1, 1, 1], 
        transition: { duration: 1.1, times: [0, 0.45, 0.65, 0.82, 1], ease: "easeOut" }
      });
  ...
  return (
    <section ref={sectionRef} className="bg-black font-jakarta px-4 py-12 sm:px-6 lg:px-10">
      <div className="mx-auto max-w-[1130px]">
        <div className="relative overflow-hidden rounded-[40px] bg-[#303147] px-6 pt-10 pb-0 sm:rounded-[50px] sm:px-10 sm:pt-12 lg:pl-12 lg:pr-0 lg:pt-0">
