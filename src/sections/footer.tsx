...
const linkColumns: {
...
}[] = [
  {
    ...
    links: [
      ...
      { label: "How it works", navLink: "How it works" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Support", href: "mailto:helpcenter@mybcash.com" },
  ...
  },
  {
    title: "Links",
    links: [
      { label: "FAQs", navLink: "FAQs" },
      { label: "Privacy Policy", href: "/privacy" },
      { label: "App Downloads", href: "https://www.apple.com/app-store/" },
    ],
  },
];
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1.15fr_1fr] lg:gap-16">
          <div className="flex flex-col gap-5">
            ...
            <p className="max-w-sm text-base font-normal text-gray-400 sm:max-w-100 sm:text-xl">
              One secure wallet for transfers, savings, and day-to-day spending.
            </p>
